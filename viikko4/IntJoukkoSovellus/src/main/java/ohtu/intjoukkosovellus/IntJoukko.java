...
public class IntJoukko {
    ...
    public IntJoukko() {
        alustaLukujono(KAPASITEETTI, OLETUSKASVATUS);
    }
    ...
    public IntJoukko(int kapasiteetti, int kasvatuskoko) {
        if (kapasiteetti < 0 || kasvatuskoko < 0) {
            throw new IndexOutOfBoundsException("Kapasitteetti/kasvatuskoko negatiiviset");
        }
        alustaLukujono(kapasiteetti, kasvatuskoko);
    }

    private void alustaLukujono(int kapasiteetti, int kasvatuskoko) {
